...
<head>
    ...
    <!-- Font Awesome CSS -->
    <link rel="stylesheet" href="ass ets/libs/fontawesome/css/all.min.css">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="admin-kampus.php" class="btn btn-sm btn-info">Kembali</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_kampus" required autofocus>
                                <small class="form-text text-danger">Nama Kampus Harus Diisi.</small>
                            </div>
                            <div class="form-group">
                                <label for="">Kota Kampus</label>
                                <input type="text" class="form-control" name="kota_kampus" required>
                                <small class="form-text text-danger">Kota Kampus Harus Diisi</small>
                            </div>
